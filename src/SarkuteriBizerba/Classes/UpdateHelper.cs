...
namespace SarkuteriBizerba.Classes
{
    ...
    {
        private const string UPDATE_URL = "https://kurulum.dinamikotomasyon.com/downloads/SarkuteriBizerba.zip";
        ...
        internal static void GuncellemeBaslat()
        {
            try
            {
                ...
                string scriptPath = Path.Combine(Application.StartupPath, "Update-SarkuteriBizerba.ps1");
        ...
        private static void CreateUpdateScript(string scriptPath)
        {
            ...
            string appName= "SarkuteriBizerba";
