@echo off
REM ========================================================================
REM  SarkuteriAdmin NSIS Setup Derleme Script
REM  Dinamik Otomasyon - 2025
REM ========================================================================

echo.
echo ========================================================================
echo   SARKUTERI ADMIN - NSIS SETUP DERLEME
echo ========================================================================
echo.
...
set NSI_FILE=%INSTALLER_DIR%SarkuteriAdmin_Setup.nsi
...
if not exist "%DEBUG_DIR%\SarkuteriAdmin.exe" (
    echo [UYARI] Debug klasorunde SarkuteriAdmin.exe bulunamadi!
    echo.
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo.
    echo Setup dosyasi: %INSTALLER_DIR%SarkuteriAdmin_Setup.exe
    echo.
    echo Simdi yapabilecekleriniz:
    echo 1. Setup dosyasini test edin
    echo 2. Hash olusturun: certutil -hashfile SarkuteriAdmin_Setup.exe SHA256
...
xcopy SarkuteriAdmin_Setup.exe C:\product_setups\ /Y