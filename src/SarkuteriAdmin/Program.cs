...
namespace SarkuteriAdmin
{
    internal static class Program
    {
        ...
        static async Task Main()
        {
            try
            {
                const string mutexName = "SarkuteriAdmin_SingleInstance_Mutex";
                bool createdNew;
                ...
                if (!createdNew)
                {
                    ...
                    DialogResult result = MessageBox.Show(
                        "SarkuteriAdmin uygulaması zaten çalışıyor.\n\n" +
                ...
                bool isLicensed = await Ruhsat.LicenseManager.CheckLicense("SARKUTERI_ADMIN");
